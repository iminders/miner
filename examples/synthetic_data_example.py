...
def main():
    ...
    stock_data = generate_synthetic_data(n_samples=1000, start_date='2010-01-01', freq='D', seed=42)
    ...
    # 创建模型目录（如果不存在）
    model_dir = '/Users/liuwen/Documents/work/repos/github.com/iminders/miner/models'
    os.makedirs(model_dir, exist_ok=True)

    # 保存模型
    logger.info("保存模型...")
    model.save_model(os.path.join(model_dir, 'synthetic_factor_model.pkl'))
